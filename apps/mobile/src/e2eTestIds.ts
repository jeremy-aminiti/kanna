export const MOBILE_E2E_IDS = {
  ...
  tabletWorkspaceShell: "mobile.tablet-workspace.shell",
  tabletWorkspaceSidebar: "mobile.tablet-workspace.sidebar",
  tabletWorkspacePane: "mobile.tablet-workspace.pane",
  tabletWorkspaceEmpty: "mobile.tablet-workspace.empty",
  ...
  taskWorkspaceTerminalTab: "mobile.task-workspace.terminal",
  taskWorkspaceFilesTab: "mobile.task-workspace.files",
  taskWorkspaceDiffTab: "mobile.task-workspace.diff",
